...
class LunarLander1(gym.Env, EzPickle):
    metadata = {
    ...
    def __init__(self):
        ...
        # set colors
        self.sky_color = (0.1, 0.1, 0.1)
        self.lander_color = (0.5,0.4,0.9)
    ...
    def reset(self):
        ...
        self.lander.color1 = self.lander_color
        self.lander.color2 = self.lander_color
        ...
        for i in [-1,+1]:
            ...
            leg.color1 = self.lander_color
            leg.color2 = self.lander_color
    ...
    def render(self, mode='human'):
        ...
        if self.viewer is None:
            ...
            img_path = os.path.join(os.path.dirname(__file__), "assets/1.png")
            img = rendering.Image2(img_path, 20, 15)
...
class LunarLanderContinuous1(LunarLander1):
    continuous = True
...
if __name__ == '__main__':
    demo_heuristic_lander(LunarLander1(), render=True)
