...
class LunarLander4(gym.Env, EzPickle):
    ...
    def __init__(self):
        ...
        # set colors
        self.sky_color = (0.7, 0.7, 0.7)
        self.lander_color = (1.0, 1.0, 0.1)
    ...
    def render(self, mode='human'):
        ...
        if self.viewer is None:
            ...
            img_path = os.path.join(os.path.dirname(__file__), "assets/4.jpg")
...
class LunarLanderContinuous4(LunarLander4):
    continuous = True
...
if __name__ == '__main__':
    demo_heuristic_lander(LunarLander4(), render=True)
