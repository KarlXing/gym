...
class LunarLander2(gym.Env, EzPickle):
    ...
    def __init__(self):
        ...
        # set colors
        self.sky_color = (0.3, 0.3, 0.3)
        self.lander_color = (0,0.4,0.9)
    ...
    def render(self, mode='human'):
        ...
        if self.viewer is None:
            ...
            img_path = os.path.join(os.path.dirname(__file__), "assets/2.jpg")
            img = rendering.Image2(img_path, 20, 20)
...
class LunarLanderContinuous2(LunarLander2):
    continuous = True
...
if __name__ == '__main__':
    demo_heuristic_lander(LunarLander2(), render=True)
