...
class LunarLander3(gym.Env, EzPickle):
    ...
    def __init__(self):
        ...
        # set colors
        self.sky_color = (0.5, 0.5, 0.5)
        self.lander_color = (1.0,1.0,1.0)
    ...
    def render(self, mode='human'):
        ...
        if self.viewer is None:
            ...
            img_path = os.path.join(os.path.dirname(__file__), "assets/3.jpg")
...
class LunarLanderContinuous3(LunarLander3):
    continuous = True
...
if __name__ == '__main__':
    demo_heuristic_lander(LunarLander3(), render=True)
