...
class LunarLander5(gym.Env, EzPickle):
    ...
    def __init__(self):
        ...
        # set colors
        self.sky_color = (0.9, 0.9, 0.9)
        self.lander_color = (0,0.7,0.0)
    ...
    def render(self, mode='human'):
        ...
        if self.viewer is None:
            ...
            img_path = os.path.join(os.path.dirname(__file__), "assets/5.jpg")
...
class LunarLanderContinuous5(LunarLander5):
    continuous = True
...
if __name__ == '__main__':
    demo_heuristic_lander(LunarLander5(), render=True)
